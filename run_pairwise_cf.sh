#!/bin/bash
# Pairwise: clone_detection + flakiness_detect — serial adapter (d=64), norm_v2
...
LR=1e-4
BDIM=64
TASKS="clone_detection,flakiness_detect"
LOSS="normalized"
GPU=3
...
run_model microsoft/unixcoder-base             unixcoder_clone_flak_adapter_norm_v2   32
run_model answerdotai/ModernBERT-base           modernbert_clone_flak_adapter_norm_v2  32
run_model Salesforce/codet5p-770m               codet5p_clone_flak_adapter_norm_v2     16
run_model deepseek-ai/deepseek-coder-1.3b-base  deepseek_clone_flak_adapter_norm_v2     8
run_model Qwen/Qwen2.5-Coder-1.5B              qwen25_clone_flak_adapter_norm_v2        8

echo ""
echo "=== Pairwise clone+flak complete — $(date) ==="
