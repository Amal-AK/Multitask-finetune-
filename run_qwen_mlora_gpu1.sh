...
set -euo pipefail
mkdir -p logs
conda run --no-capture-output -n multitask env CUDA_VISIBLE_DEVICES=1 python -u run_mlora.py \
    ...
    --output_model_name qwen25_mlora_norm_v2_300k \
    2>&1 | tee logs/qwen25_mlora_norm_v2_300k.log
